...
// ==/UserScript==
 ...
 /**
* @license MIT
* Copyright (c) Tony-the-best 2025
*
...
* https://github.com/Tony-the-best/Blooket-hacks
...
function footer() {
    ...
    element.innerHTML = `<p>Anti-Ban system online Ported by PrimeKidMN and Scripted by rxzyz <br>  <a style="color: #0000ff; target="_blank">GitHub</a></p>`;
    ...
    const cheat = (async () => {
        ...
        function GUI() {
            ...
            return makeElement("div", {
                ...
                onClick: () => window.open("https://gitlab.com/Tony-the-best/ye", "_blank").focus(),
                style: {
                    cursor: "pointer"
                },
                href: "https://gitlab.com/Tony-the-best/ye"
            }, "GitHub - Tony-the-best")), makeElement("div", {
